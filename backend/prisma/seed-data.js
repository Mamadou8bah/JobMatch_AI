...
exports.SEED_IDS = exports.SEED_PASSWORD_ADMIN = exports.SEED_PASSWORD_DEMO = void 0;
exports.runDatabaseSeed = runDatabaseSeed;
const client_1 = require("@prisma/client");
const bcrypt = require("bcryptjs");
exports.SEED_PASSWORD_DEMO = '11111111';
exports.SEED_PASSWORD_ADMIN = 'Admin12345!';
exports.SEED_IDS = {
    users: {
...
async function upsertUser(prisma, id, data) {
...
async function runDatabaseSeed(prisma) {
    const demoHash = await bcrypt.hash(exports.SEED_PASSWORD_DEMO, 10);
    const adminHash = await bcrypt.hash(exports.SEED_PASSWORD_ADMIN, 10);
    const u = exports.SEED_IDS.users;
    const userIds = {};
    ...
    const jobs = [
        ...
        },
        {
            ...
            status: client_1.JobStatus.PENDING_REVIEW,
            views: 34,
        },
        {
            id: j.backendDev,
        ...
        },
        {
            ...
            status: client_1.JobStatus.REJECTED,
            views: 18,
        },
        {
            id: j.farmSupervisor,
    ...
    const applications = [
        { jobId: j.frontend, applicantId: userIds.bah, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 88, coverLetter: 'I am excited to contribute to Atlantic Tech.' },
        { jobId: j.frontend, applicantId: userIds.fatou, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.INTERVIEW, matchScore: 94, coverLetter: 'React and TypeScript are my core strengths.' },
        { jobId: j.frontend, applicantId: userIds.modou, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.PENDING, matchScore: 71 },
        { jobId: j.dataAnalyst, applicantId: userIds.bah, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.PENDING, matchScore: 72 },
        { jobId: j.dataAnalyst, applicantId: userIds.laminSeeker, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 85 },
        { jobId: j.customerSupport, applicantId: userIds.bah, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.HIRED, matchScore: 91 },
        { jobId: j.customerSupport, applicantId: userIds.neneh, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 89 },
        { jobId: j.backendDev, applicantId: userIds.modou, employerId: userIds.employerKotu, status: client_1.ApplicationStatus.INTERVIEW, matchScore: 82 },
        { jobId: j.backendDev, applicantId: userIds.fatou, employerId: userIds.employerKotu, status: client_1.ApplicationStatus.REJECTED, matchScore: 58 },
        { jobId: j.mobileDev, applicantId: userIds.fatou, employerId: userIds.employerKotu, status: client_1.ApplicationStatus.PENDING, matchScore: 86 },
        { jobId: j.uxDesigner, applicantId: userIds.haddy, employerId: userIds.employerKotu, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 79 },
        { jobId: j.salesRep, applicantId: userIds.omar, employerId: userIds.employerRetail, status: client_1.ApplicationStatus.INTERVIEW, matchScore: 92 },
        { jobId: j.salesRep, applicantId: userIds.yusupha, employerId: userIds.employerRetail, status: client_1.ApplicationStatus.PENDING, matchScore: 64 },
        { jobId: j.tourGuide, applicantId: userIds.neneh, employerId: userIds.employerTourism, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 88 },
        { jobId: j.accountant, applicantId: userIds.mariama, employerId: userIds.employerFinance, status: client_1.ApplicationStatus.INTERVIEW, matchScore: 90 },
        { jobId: j.accountant, applicantId: userIds.yusupha, employerId: userIds.employerFinance, status: client_1.ApplicationStatus.REJECTED, matchScore: 45 },
        { jobId: j.nurse, applicantId: userIds.aisha, employerId: userIds.employerRetail, status: client_1.ApplicationStatus.HIRED, matchScore: 95 },
        { jobId: j.electrician, applicantId: userIds.ibrahim, employerId: userIds.employerAgro, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 93 },
        { jobId: j.teacher, applicantId: userIds.kaddy, employerId: userIds.employerSkills, status: client_1.ApplicationStatus.PENDING, matchScore: 87 },
        { jobId: j.driver, applicantId: userIds.samba, employerId: userIds.employerRiver, status: client_1.ApplicationStatus.INTERVIEW, matchScore: 96 },
        { jobId: j.dataEntry, applicantId: userIds.yusupha, employerId: userIds.employerFinance, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 83 },
        { jobId: j.dataEntry, applicantId: userIds.bah, employerId: userIds.employerFinance, status: client_1.ApplicationStatus.PENDING, matchScore: 68 },
        { jobId: j.projectManager, applicantId: userIds.binta, employerId: userIds.employerAtlantic, status: client_1.ApplicationStatus.PENDING, matchScore: 88 },
        { jobId: j.socialMedia, applicantId: userIds.haddy, employerId: userIds.employerKotu, status: client_1.ApplicationStatus.PENDING, matchScore: 91 },
        { jobId: j.farmSupervisor, applicantId: userIds.ibrahim, employerId: userIds.employerAgro, status: client_1.ApplicationStatus.PENDING, matchScore: 74 },
        { jobId: j.security, applicantId: userIds.samba, employerId: userIds.employerRetail, status: client_1.ApplicationStatus.REJECTED, matchScore: 52 },
        { jobId: j.contentWriter, applicantId: userIds.haddy, employerId: userIds.employerTourism, status: client_1.ApplicationStatus.SHORTLISTED, matchScore: 80 },
        { jobId: j.hrAssistant, applicantId: userIds.binta, employerId: userIds.employerFinance, status: client_1.ApplicationStatus.PENDING, matchScore: 77 },
    ];
    ...
    for (const course of courses) {
        await prisma.trainingCourse.upsert({
            ...
            update: {
                ...
                url: course.url,
                status: client_1.TrainingCourseStatus.ACTIVE,
            },
            create: { ...course, status: client_1.TrainingCourseStatus.ACTIVE },
        });
    }
    const notifications = [
        { userId: userIds.bah, title: 'Application shortlisted', message: 'Your application for Frontend Developer was shortlisted.', type: client_1.NotificationType.APPLICATION, read: false },
        { userId: userIds.bah, title: 'New job match', message: 'Customer Support Specialist is a 91% match for your profile.', type: client_1.NotificationType.JOB, read: false },
        { userId: userIds.bah, title: 'Training recommendation', message: 'SQL Basics may help close your skills gap.', type: client_1.NotificationType.INFO, read: true },
        { userId: userIds.fatou, title: 'Interview scheduled', message: 'Atlantic Tech invited you to interview for Frontend Developer.', type: client_1.NotificationType.APPLICATION, read: false },
        { userId: userIds.fatou, title: 'New message', message: 'You have a new message from Kotu Digital.', type: client_1.NotificationType.CHAT, read: false },
        { userId: userIds.employerAtlantic, title: 'New application', message: 'Fatou A. applied for Frontend Developer (94% match).', type: client_1.NotificationType.APPLICATION, read: false },
        { userId: userIds.employerAtlantic, title: 'Job published', message: 'Data Analyst is now live on JobMatch AI.', type: client_1.NotificationType.JOB, read: true },
        { userId: userIds.employerRiver, title: 'Account pending', message: 'Your employer account is awaiting admin approval.', type: client_1.NotificationType.WARNING, read: false },
        { userId: userIds.mariama, title: 'Interview reminder', message: 'Junior Accountant interview tomorrow at 10:00.', type: client_1.NotificationType.APPLICATION, read: false },
        { userId: userIds.aisha, title: 'Congratulations!', message: 'You were hired for Community Health Nurse.', type: client_1.NotificationType.SUCCESS, read: false },
        { userId: userIds.admin, title: 'Jobs pending review', message: '3 job postings await moderation.', type: client_1.NotificationType.SYSTEM, read: false },
        { userId: userIds.omar, title: 'Application update', message: 'Your Sales Representative application moved to interview.', type: client_1.NotificationType.APPLICATION, read: true },
        { userId: userIds.haddy, title: 'Skills gap insight', message: 'Complete Figma UI Design to improve UX Designer matches.', type: client_1.NotificationType.INFO, read: false },
        { userId: userIds.samba, title: 'New job match', message: 'Delivery Driver is a 96% match for your profile.', type: client_1.NotificationType.JOB, read: false },
        { userId: userIds.kaddy, title: 'Training path', message: 'Teaching Methods course recommended for Vocational Trainer.', type: client_1.NotificationType.INFO, read: true },
    ];
    ...
    const t = exports.SEED_IDS.threads;
    await prisma.chatThread.upsert({
        ...
        create: {
            ...
            jobId: j.frontend,
            status: client_1.ChatThreadStatus.OPEN,
    ...
    await prisma.chatThread.upsert({
        ...
        create: {
            ...
            applicantId: userIds.bah,
            jobId: j.dataAnalyst,
            status: client_1.ChatThreadStatus.CLOSED,
